function loadPosts() {
  ...
  if (posts.length === 0) {
      ...
      posts.forEach((post, index) => {
          ...
          const carregarButton = document.createElement('button');
          carregarButton.classList.add('carregar-btn');
          carregarButton.onclick = () => carregarPost();
          tituloCell.appendChild(carregarButton);
